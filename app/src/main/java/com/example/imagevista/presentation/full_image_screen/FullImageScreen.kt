...
import com.example.imagevista.presentation.component.DownloadOptionBottomSheet
...
fun FullImageScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        DownloadOptionBottomSheet(
            ...
            onOptionClick = { option ->
                ...
                val url = when(option){
                    ...
                    ImageDownloadOption.LARGE -> image?.imageUrlRaw
                }
                url?.let { onImageDownloadClick(it,image?.description?.take(20)) }
        ...
        FullImageViewTopBar(
            ...
            onPhotographerNameClick = onPhotographerImageClick,
